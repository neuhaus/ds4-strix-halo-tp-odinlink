...
CORE_OBJS = ds4.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o ds4_glm5_kda.o ds4_glm5_next_runtime.o ds4_glm5_next_state.o ds4_glm5_next_exec.o
...
CORE_OBJS = ds4.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_glm5_kda.o ds4_glm5_next_runtime.o ds4_glm5_next_state.o ds4_glm5_next_exec.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o ds4_glm5_kda_schedule.o ds4_glm5_next_runtime.o
...
test-successor-quality-test:
	@bash -n scripts/run-successor-quality-test.sh
	@python3 -m json.tool quality-thresholds.successor.json >/dev/null
...
.PHONY: test-rocm-glm5-q4k-cold-lds5
test-rocm-glm5-q4k-cold-lds5: tests/test_rocm_glm5_q4k_batch_partition
	@set -e; for rows in 256 512 768 1000 1024; do \
		DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" ./tests/test_rocm_glm5_q4k_batch_partition $$rows --cold-lds5; \
	done

.PHONY: test-rocm-glm5-q4k-cold-lds5-padding
test-rocm-glm5-q4k-cold-lds5-padding: tests/test_rocm_glm5_q4k_batch_partition
	@set -e; for rows in 256 512 768 1000 1024; do \
...
test-rocm-glm5-q4k-decode-dot4: tests/test_rocm_glm5_q4k_batch_partition
	@set -e; for fixture in 0 1 2; do \
		DS4_TEST_MOE_INPUT_CASE=$$fixture DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" \
		./tests/test_rocm_glm5_q4k_batch_partition 1 --decode-dot4; \
	done
...
test-rocm-glm5-q4k-decode-rows: tests/test_rocm_glm5_q4k_batch_partition
	@set -e; for fixture in 0 1 2; do for span in 32 64; do \
		DS4_TEST_MOE_INPUT_CASE=$$fixture DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" \
		./tests/test_rocm_glm5_q4k_batch_partition 1 --decode$$span; \
	done; done
...
tests/test_rocm_glm5_six_prefill_exact: tests/test_rocm_glm5_six_prefill_exact.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o ds4_glm5_next_runtime.o
	$(HIPCC) $(ROCM_CFLAGS) -o $@ $^ $(ROCM_LDLIBS)
...
tests/test_rocm_glm5_dense_q8_small_m.o: tests/test_rocm_glm5_dense_q8_small_m.cu tests/glm5_gguf_test.hpp ds4_glm5_next_exec.h ds4_gpu.h ds4_gpu_mgpu.h ds4_tp.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<

tests/test_rocm_glm5_dense_q8_small_m: tests/test_rocm_glm5_dense_q8_small_m.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)

tests/test_rocm_glm5_shared_q8_small_m.o: tests/test_rocm_glm5_shared_q8_small_m.cu tests/glm5_gguf_test.hpp ds4_glm5_next_exec.h ds4_gpu.h ds4_gpu_mgpu.h ds4_tp.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<

tests/test_rocm_glm5_shared_q8_small_m: tests/test_rocm_glm5_shared_q8_small_m.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)

tests/test_rocm_glm5_mla_output_small_m.o: tests/test_rocm_glm5_mla_output_small_m.cu tests/glm5_gguf_test.hpp ds4_glm5_next_exec.h ds4_gpu.h ds4_gpu_mgpu.h ds4_tp.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<
...
.PHONY: test-rocm-glm5-bf16-embedding
tests/test_rocm_glm5_bf16_embedding.o: tests/test_rocm_glm5_bf16_embedding.cu tests/glm5_gguf_test.hpp ds4_gpu.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -I. -c -o $@ $<

tests/test_rocm_glm5_bf16_embedding: tests/test_rocm_glm5_bf16_embedding.o tests/ds4_tp_hello_test.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)
...
tests/test_rocm_glm5_dense_block0: tests/test_rocm_glm5_dense_block0.o ds4_glm5_kda.o ds4_glm5_next_runtime.o ds4_glm5_next_state.o ds4_glm5_next_exec.o tests/ds4_tp_hello_test.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)
...
tests/ds4_glm5_next_exec_test.o: ds4_glm5_next_exec.c ds4_glm5_route_profile.h ds4_glm5_next_exec.h ds4_glm5_next_runtime.h ds4_glm5_kda.h ds4_gpu.h ds4_tp.h
...
test-rocm-glm5-output-head: tests/test_rocm_glm5_output_head
	@test -n "$(DS4_GLM5_MODEL)" || { echo "DS4_GLM5_MODEL is required" >&2; exit 1; }
	DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" ./tests/test_rocm_glm5_output_head
...
tests/test_rocm_glm5_mla_qkv: tests/test_rocm_glm5_mla_qkv.o tests/ds4_tp_hello_test.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)

test-rocm-glm5-mla-qkv: tests/test_rocm_glm5_mla_qkv
	@test -n "$(DS4_RESEARCH_ROOT)" || { echo "DS4_RESEARCH_ROOT is required" >&2; exit 1; }
	@test -n "$(DS4_GLM5_MODEL)" || { echo "DS4_GLM5_MODEL is required" >&2; exit 1; }
	python3 scripts/probe-glm5-next-mla-qkv.py \
		--layer 3 --rows 10 \
		--output "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/mla-qkv-layer3-oracle.json" \
		--dump-prefix "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/raw/mla-qkv-layer3" \
		"$(DS4_GLM5_MODEL)" >/dev/null
	DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" \
...
.PHONY: bench-rocm-glm5-q8-sharedx-prefetch
tests/glm5_q8_sharedx_prefetch_bench.o: scripts/glm5_q8_sharedx_prefetch_bench.cu tests/glm5_gguf_test.hpp ds4_gpu.h ds4_gpu_mgpu.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -I. -c -o $@ $<

tests/glm5_q8_sharedx_prefetch_bench: tests/glm5_q8_sharedx_prefetch_bench.o tests/ds4_tp_hello_test.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)
...
tests/test_rocm_glm5_mla_compose: tests/test_rocm_glm5_mla_compose.o tests/ds4_tp_hello_test.o ds4_glm5_next_runtime.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)
...
.PHONY: test-rocm-glm5-ffn-shared-compose
tests/test_rocm_glm5_ffn_shared_compose.o: tests/test_rocm_glm5_ffn_shared_compose.cu tests/glm5_gguf_test.hpp ds4_gpu.h ds4_gpu_mgpu.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -I. -c -o $@ $<

tests/test_rocm_glm5_ffn_shared_compose: tests/test_rocm_glm5_ffn_shared_compose.o tests/ds4_tp_hello_test.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ $(ROCM_LDLIBS)

test-rocm-glm5-ffn-shared-compose: tests/test_rocm_glm5_ffn_shared_compose
	@test -n "$(DS4_RESEARCH_ROOT)" || { echo "DS4_RESEARCH_ROOT is required" >&2; exit 1; }
	@test -n "$(DS4_GLM5_MODEL)" || { echo "DS4_GLM5_MODEL is required" >&2; exit 1; }
	@test -n "$(DS4_GLM5_FFN_SHARED_TAG)" || { echo "DS4_GLM5_FFN_SHARED_TAG is required" >&2; exit 1; }
	@case "$(DS4_GLM5_FFN_SHARED_TAG)" in *[!A-Za-z0-9._-]*|'') echo "invalid DS4_GLM5_FFN_SHARED_TAG" >&2; exit 1;; esac
	@test ! -e "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/$(DS4_GLM5_FFN_SHARED_TAG)" || { echo "refusing to overwrite evidence tag" >&2; exit 1; }
	mkdir -p "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/$(DS4_GLM5_FFN_SHARED_TAG)/raw"
	python3 scripts/probe-glm5-next-mla-compose.py \
		--layer 3 --rows 10 --first-valid 1 \
		--output "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/$(DS4_GLM5_FFN_SHARED_TAG)/oracle.json" \
		--dump-prefix "$(DS4_RESEARCH_ROOT)/glm5-next-tp2/$(DS4_GLM5_FFN_SHARED_TAG)/raw/mla-ffn-layer3" \
		"$(DS4_GLM5_MODEL)" >/dev/null
	DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" \
	DS4_GLM5_MLA_COMPOSE_ORACLE_PREFIX="$(DS4_RESEARCH_ROOT)/glm5-next-tp2/$(DS4_GLM5_FFN_SHARED_TAG)/raw/mla-ffn-layer3" \
		./tests/test_rocm_glm5_ffn_shared_compose
...
tests/test_tp_glm5_phase_transition.o: tests/test_tp_glm5_phase_transition.cu ds4_tp.h ds4_glm5_next_runtime.h ds4.h
	$(HIPCC) $(ROCM_CFLAGS) -I. -c -o $@ $<

tests/test_tp_glm5_phase_transition: tests/test_tp_glm5_phase_transition.o tests/ds4_tp_completion_ordering.o ds4_glm5_next_runtime.o
	$(HIPCC) $(ROCM_CFLAGS) -Wl,--gc-sections -o $@ $^ -lm -pthread -ldl

test-tp-glm5-phase-transition: tests/test_tp_glm5_phase_transition
	@test -n "$(ROLE)" -a -n "$(ADDRESS)" -a -n "$(RDMA_DEVICE)" || { \
		echo "error: set ROLE, ADDRESS, and RDMA_DEVICE" >&2; exit 2; }
	./tests/test_tp_glm5_phase_transition "$(ROLE)" "$(ADDRESS)" \
		"$${PORT:-15912}" "$(RDMA_DEVICE)" "$${GID_INDEX:--1}"
...
ds4_glm5_kda_schedule.o: ds4_glm5_kda.c ds4_glm5_kda.h
	$(CC) $(CFLAGS) -DDS4_GLM5_KDA_SCHEDULE_ONLY -c -o $@ ds4_glm5_kda.c
...
tests/test_engine_mgpu_placement: tests/test_engine_mgpu_placement.o ds4_cpu_test_hooks.o tests/ds4_glm5_kda_schedule.o ds4_glm5_next_runtime.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -Wl,--gc-sections -o $@ $^ $(LDLIBS)
...
.PHONY: test-rocm-q8-kslice-rows
tests/test_rocm_q8_kslice_rows.o: tests/test_rocm_q8_kslice_rows.cu ds4_gpu.h ds4_gpu_mgpu.h
	$(HIPCC) $(HIPFLAGS) -I. -c $< -o $@

tests/test_rocm_q8_kslice_rows: tests/test_rocm_q8_kslice_rows.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(HIPFLAGS) $^ -o $@ $(ROCM_LDLIBS)
...
.PHONY: test-rocm-glm5-kda-bf16-rowslice
...
tests/test_rocm_glm5_kda_real_activation_oracle.o: tests/test_rocm_glm5_kda_real_activation_oracle.cu tests/glm5_gguf_test.hpp ds4_gpu.h ds4_gpu_mgpu.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<

tests/test_rocm_glm5_kda_real_activation_oracle: tests/test_rocm_glm5_kda_real_activation_oracle.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o
	$(HIPCC) $(ROCM_CFLAGS) -o $@ $^ $(ROCM_LDLIBS)

test-rocm-glm5-kda-real-activation-oracle: tests/test_rocm_glm5_kda_real_activation_oracle
	@test -n "$(DS4_RESEARCH_ROOT)" || { echo "error: set DS4_RESEARCH_ROOT" >&2; exit 2; }
	DS4_GLM5_MODEL="$(DS4_GLM5_MODEL)" \
	DS4_GLM5_KDA_ORACLE_ROOT="$(DS4_RESEARCH_ROOT)/glm5-next-tp2/kda-real-activation-oracle-20260831" \
	DS4_GLM5_KDA_ORACLE_LAYER=5 \
		./tests/test_rocm_glm5_kda_real_activation_oracle
...
tests/test_engine_mgpu_runtime: tests/test_engine_mgpu_runtime.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_glm5_kda.o ds4_glm5_next_runtime.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_sampling: tests/test_sampling.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_glm5_kda.o ds4_glm5_next_runtime.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_cuda_mixed_batch: tests/test_cuda_mixed_batch.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_glm5_kda.o ds4_glm5_next_runtime.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
clean:
	rm -f ds4 ds4-server ds4-bench ds4-bench-tp ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test ds4_agent_test gguf-tools/quality-testing/score_official gguf-tools/quality-testing/score_official.o tests/test_q4k_dot tests/test_tp_hello tests/test_tp_completion_ordering tests/test_tp_glm5_phase_transition tests/test_tp_dual_stream_progress tests/test_metal_session_batch tests/test_gpu_xdev tests/test_rocm_attention_output_tp tests/test_rocm_attention_decode_mixed tests/test_rocm_attention_decode_indexed_seqtile tests/test_rocm_attention_prefill_static_flash tests/attn_static_flash_lds_bench tests/test_rocm_q4k_decode_bench tests/test_rocm_shared_routed_overlap tests/test_rocm_q4k_fused_mid tests/test_rocm_q4k_staged_midq_oracle tests/test_rocm_q4k_ffn_row_balance_oracle tests/test_rocm_q4k_packed_slice_registry tests/test_rocm_shared_gu_swiglu_fused tests/test_rocm_q8_pair_pack4 tests/test_rocm_q8_kslice_rows tests/test_rocm_attention_q_b_fused tests/test_rocm_glm5_kda_layer tests/test_rocm_glm5_kda_bf16_rowslice tests/test_rocm_glm5_kda_real_activation_oracle tests/test_rocm_glm5_mhc_layer tests/test_rocm_glm5_bf16_embedding tests/test_rocm_glm53_expert_window tests/test_rocm_glm5_q4k_shard_compose tests/test_rocm_glm5_router_realweight tests/test_glm5_kda_binding tests/test_glm5_kda_state tests/test_glm5_next_runtime_offsets tests/test_glm5_next_text_codec tests/test_gpu_model_cache tests/test_gpu_lookup_cache_strict tests/test_engine_mgpu_refusal tests/test_engine_mgpu_runtime tests/test_engine_correctness tests/test_sampling tests/test_cuda_session_batch tests/test_cuda_mixed_batch tests/glm5_q8_sharedx_prefetch_bench tests/*.o *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o tests/rocm_long_context_smoke tests/rocm_long_context_smoke.o
