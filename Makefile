...
tests/test_rocm_glm5_layer_verify.o: tests/test_rocm_glm5_layer_verify.cu tests/glm5_native_draft_checks.hpp tests/glm5_next_real_offsets.hpp tests/glm5_gguf_test.hpp ds4_glm5_next_exec.h ds4_glm5_next_runtime.h ds4_gpu.h ds4_tp.h
	$(HIPCC) $(ROCM_PRECISE_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<
